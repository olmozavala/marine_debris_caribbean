...
from proj_utils_loc.ParticlesByCountry import indexForCountries
...
if __name__ == "__main__":
    ...
    input_folder = config[CommonParams.output_folder]
    input_file = config[CommonParams.output_file]
    file_name = join(input_folder, input_file)

    lat_files = config[CommonParams.lat_files]
    lon_files = config[CommonParams.lon_files]
    release_loc_folder = config[CommonParams.loc_folder]
