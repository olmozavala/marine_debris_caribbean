...
if __name__ == "__main__":
    ...
    # output_folder = "/data/COAPS_Net/work/ozavala/CARIBBEAN_marine_debris/statistics/FromCaribbean"
    # makeJsonAndCsvFiles(input_folder, output_folder)
    # ----------------- Multiple years ---------------
    years = range(2017,2022)
    root_input_folder = "/nexsan/people/xbxu/HYCOM/GLBv0.08"
    root_output_folder = "/data/COAPS_Net/work/ozavala/CARIBBEAN_marine_debris/statistics/FromCaribbean/json"
    for year in years:
